...
pub(in crate::tmux::native) struct CommandSpec {
    pub(in crate::tmux::native) name: &'static str,
    pub(in crate::tmux::native) alias: Option<&'static str>,
    pub(in crate::tmux::native) command: Command,
}
...
pub(in crate::tmux::native) static COMMAND_SPECS: &[CommandSpec] = &[
    CommandSpec::new(
        "attach-session",
        Some("attach"),
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(in crate::tmux::native) enum SpecResolution {
...
pub(in crate::tmux::native) fn resolve_spec(word: &str) -> SpecResolution {
